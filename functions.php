	...
	function bootstrap_setup(){
		...
		class Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu {
			...
			function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
				...
				//$attributes .= ($args->has_children) 	    ? ' class="dropdown-toggle needsclick" data-toggle="dropdown"' : '';
				...
				if($args->has_children) {
					$item_output .= '</li>'."\n".'<li class="dropdown">';
					$item_output .= "\n\t".'<a class="dropdown-toggle needsclick caret-after visible-desktop" data-toggle="dropdown"><i class="icon-caret-down"></i></a>';
				}
